...
const PORTRAIT_ICONS = [
  ...
  <svg key="provider" viewBox="0 0 20 20" fill="none" className="h-5 w-5 text-teal">
    <path
  ...
  <svg key="venue" viewBox="0 0 20 20" fill="none" className="h-5 w-5 text-teal">
    <path
